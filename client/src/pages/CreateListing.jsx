...
export default function CreateListing() {
  ...
  return (
    ...
    <div className='px-7 mt-7 pt-2 pb-6 max-w-4xl mx-auto rounded-xl bg-slate-200 '>
        <h1 className='text-3xl font-bold text-center mb-7 text-[#42c8b7]'>POST YOUR AD</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-6 flex-1'>
                    ...
                    <div className='relative cursor-pointer '> 
                        ...
                        <div value={selectedItemCategory || ""} onMouseEnter={() => setIsOpenCategory(true)} onMouseLeave={() => setIsOpenCategory(false)} className="right-[0px] md:left-[0px] absolute top-[53px] bg-gray-100 flex flex-col rounded-xl w-full  ">
                            <div className="z-50">
                                ...
                                <div onClick={()=>{handleDropdownChangeCategory("Ticket"); setIsOpenCategory(false)}} className="p-1 border-s-black hover:bg-[#42c8b7] rounded-lg text-base">Ticket</div>
                ...
                {/* Price */}
                <div className='gap-y-0 bg-slate-300 rounded-lg py-1 mt-5'>
                    <div className='flex flex-col gap-0.5 '>
                        <p className='font-bold text-slate-700 uppercase px-2 text-lg '>Set a Price</p>
                        <div className='relative'>
                            <FaRupeeSign className='absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-500' />
                            <input 
                                ...
                                required 
                                className='pl-10 p-3 rounded-lg w-full'
                            />
                        </div>
                    </div>
                    <div className='flex gap-6 flex-wrap text-base mt-0.5 ml-0.5'>
                    ...
                    <div className='flex gap-x-6 flex-wrap bg-slate-300 p-1 text-lg items-center rounded-lg '>
                        ...
                        <label className='flex-1 flex items-center cursor-pointer'>
                            <input 
                                ...
                                className='cursor-pointer w-5 h-5' 
                                onChange={handleChange} 
                                checked={formData.location === 'insideIITK'}
                            />
                            <span className='ml-2'>Inside IITK</span>
                        </label>
                        ...
                        <label className='flex-1 flex items-center cursor-pointer'>
                            <input 
                                ...
                                className='cursor-pointer w-5 h-5' 
                                onChange={handleChange} 
                                checked={formData.location === 'outsideIITK'}
                            />
                            <span className='ml-2'>Outside IITK</span>
                        </label>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button disabled={loading || uploading } className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'> {loading ? 'Posting...' : 'Post Ad'} </button>
            </div>
